...
*Для каких интерфейсов в пределах сети не следует использовать протоколы обнаружения сетевых ресурсов? - Для интерфейсов, которые смотрят в сторону клиентов, т.к. зная модель оборудованияи версию софта, можно использовать эксплоит для атаки на оборудование*
